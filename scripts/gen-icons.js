...
/**
 * Generates src/embeddedjs/modules/icons/library.js from
...
const OUT = join(ROOT, "src/embeddedjs/modules/icons/library.js");
...
const entries = glyphs
	.map(g => {
		...
		return `export const ${toCamel(g.extras.name)} = ${literal};`;
	})
	.join("\n");
